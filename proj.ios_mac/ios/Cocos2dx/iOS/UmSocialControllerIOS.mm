...
void UmSocialControllerIOS::setWechatAppId(const char *appId,const char *appKey,const char *url){
    #if CC_ShareToWechat == 1
//    [UMSocialWechatHandler setWXAppId:getNSStringFromCString(appId) url:@"http://www.umeng.com/social"];
    [UMSocialWechatHandler setWXAppId:getNSStringFromCString(appId)appSecret:getNSStringFromCString(appKey)url:getNSStringFromCString(appKey)];
